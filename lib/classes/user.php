...
class core_user {
    ...
    /**
     * Return user object from db based on their idnumber.
     *
     ...
     * @throws dml_exception if user record not found and respective $strictness is set.
     */
    public static function get_user_by_idnumber($idnumber, $fields = '*', $mnethostid = null, $strictness = IGNORE_MISSING) {
        global $DB, $CFG;
        ...
        return $DB->get_record('user', array('idnumber' => $idnumber, 'mnethostid' => $mnethostid), $fields, $strictness);
    }
